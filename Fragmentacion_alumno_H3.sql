...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `alumno_h3`
--
CREATE TABLE
    `alumno_h3` (
...
--
--
-- Indices de la tabla `alumno_h3`
--
ALTER TABLE `alumno_h3` ADD PRIMARY KEY (`codigo`),
...
--
--
-- AUTO_INCREMENT de la tabla `alumno_h3`
--
ALTER TABLE `alumno_h3` MODIFY `codigo` int (5) NOT NULL AUTO_INCREMENT;