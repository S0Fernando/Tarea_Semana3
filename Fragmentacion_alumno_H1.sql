...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `alumno_h1`
--
CREATE TABLE
    `alumno_h1` (
...
--
ALTER TABLE `alumno_h1` ADD PRIMARY KEY (`codigo`),
...
--
ALTER TABLE `alumno_h1` MODIFY `codigo` int (5) NOT NULL AUTO_INCREMENT;