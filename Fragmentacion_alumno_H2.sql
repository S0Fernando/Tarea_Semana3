...
-- --------------------------------------------------------
--
-- Estructura de tabla para la tabla `alumno_h2`
--
CREATE TABLE
    `alumno_h2` (
...
--
--
-- Indices de la tabla `alumno_h2`
--
ALTER TABLE `alumno_h2` ADD PRIMARY KEY (`codigo`),
...
--
--
-- AUTO_INCREMENT de la tabla `alumno_h2`
--
ALTER TABLE `alumno_h2` MODIFY `codigo` int (5) NOT NULL AUTO_INCREMENT;